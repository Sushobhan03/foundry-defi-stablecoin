...
A Decentralised Stablecoin implementation governed by the DSCEngine smart contract.
...
```
git clone https://github.com/Sushobhan03/foundry-defi-stablecoin.git
...
- The latest version of openzeppelin-contracts has changes in the ERC20Mock file. To follow along with the course, you need to install version 4.8.0 which can be done by `forge install openzeppelin/openzeppelin-contracts@v4.8.0` instead of `forge install openzeppelin/openzeppelin-contracts`
